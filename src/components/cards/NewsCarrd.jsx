...
const NewsCard = ({news}) => {
  ...
  return (
    <div className=' w-fit shadow-md shadow-[#a3a0a0] '><div className="card " style={ {width: '18rem',minHeight:'20rem'}}>
    <img src={news.urlToImage} className="card-img-top h-[145px]" alt="..."/>
